		...
		)
{
	...
	*this += new wxHyperlinkCtrl(this, wxID_ANY,
		_("Contributors v1.4 and higher"), L"https://github.com/PCSX2/pcsx2/graphs/contributors"
	) | pxProportion(1).Center().Border(wxALL, 3);

	*this += new wxHyperlinkCtrl(this, wxID_ANY,
		_("Contributors for older versions"), L"https://pcsx2.net/meet-the-team.html"
	) | pxProportion(1).Center().Border(wxALL, 3);
